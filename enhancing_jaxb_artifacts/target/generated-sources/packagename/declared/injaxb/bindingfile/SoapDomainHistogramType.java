...
public class SoapDomainHistogramType
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElement(name = "Domain")
    protected List<SoapHistogramEntryType> domain;
     ...
     * {@link SoapHistogramEntryType }
     * 
     * 
     */
    public List<SoapHistogramEntryType> getDomain() {
        if (domain == null) {
            domain = new ArrayList<SoapHistogramEntryType>();
        }
        return this.domain;
    }
