...
@XmlEnum
public enum SoapUserStatusCodeType {
    ...
    SoapUserStatusCodeType(String v) {
        value = v;
    }
    ...
    public static SoapUserStatusCodeType fromValue(String v) {
        for (SoapUserStatusCodeType c: SoapUserStatusCodeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
