...
@XmlEnum
public enum SoapProductStateCodeType {
    ...
    SoapProductStateCodeType(String v) {
        value = v;
    }
    ...
    public static SoapProductStateCodeType fromValue(String v) {
        for (SoapProductStateCodeType c: SoapProductStateCodeType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
